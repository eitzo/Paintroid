...
docker run -it --rm -u 1000:1000 -v /dev/kvm:/dev/kvm:Z -e JENKINS_URL="notEmpty" -v $HOME/.gradle:/home/user/.gradle -w ${WORKINGDIR} -v ${WORKINGDIR}:${WORKINGDIR}:rw,z paintroid:${VERSION}
